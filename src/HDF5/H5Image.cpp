                            ...
                            const unsigned char *buffer )
{
 ...
 if ( H5Lite::writeAttribute( loc_id, datasetName, const_cast<std::string&>(H5ImageConst::ImageClass), const_cast<std::string&>(H5ImageConst::Image) ) < 0 )
  return -1;
 ...
 if ( H5Lite::writeAttribute( loc_id, datasetName, const_cast<std::string&>(H5ImageConst::ImageSubclass), const_cast<std::string&>(H5ImageConst::ImageIndexed) ) < 0 )
  return -1;
                             ...
                             const unsigned char *buffer )
{
 ...
 /* Attach the IMAGE_SUBCLASS attribute */
 if ( H5Lite::writeAttribute( loc_id, datasetName, const_cast<std::string&>(H5ImageConst::ImageSubclass), const_cast<std::string&>(H5ImageConst::ImageTrueColor) ) < 0 )
  return -1;

 /* Attach the INTERLACE_MODE attribute. This attributes is only for true color images */
 if ( H5Lite::writeAttribute( loc_id, datasetName, const_cast<std::string&>(H5ImageConst::InterlaceMode), const_cast<std::string&>(interlace) ) < 0 )
  return -1;
...

{
 ...
 if ( H5Lite::writeAttribute( loc_id, pal_name, const_cast<std::string&>(H5ImageConst::ImageClass), const_cast<std::string&>(H5ImageConst::Palette) ) < 0 )
  return -1;

 /* Attach the attribute const_cast<std::string&>(H5ImageConst::PalVersion) to the >>palette<< dataset*/
 if ( H5Lite::writeAttribute( loc_id, pal_name, const_cast<std::string&>(H5ImageConst::PalVersion), const_cast<std::string&>(H5ImageConst::PalVersionValue) ) < 0 )
  return -1;
