...
#-- Find a Debug Library ---------------------------------------------
 ...
 IF (BOOST_DATE_TIME_LIBRARY_DEBUG)
  SET(BOOST_DEBUG_LIBRARIES ${BOOST_DEBUG_LIBRARIES} ${BOOST_DATE_TIME_LIBRARY_DEBUG} )
...
#-- Find a Release Library -------------------------------------------
 ...
 IF (BOOST_DATE_TIME_LIBRARY_RELEASE)
  SET(BOOST_RELEASE_LIBRARIES ${BOOST_DEBUG_LIBRARIES} ${BOOST_DATE_TIME_LIBRARY_RELEASE} )
...
#-- Find a Debug Library ---------------------------------------------
 ...
 IF (BOOST_FILESYSTEM_LIBRARY_DEBUG)
  SET(BOOST_DEBUG_LIBRARIES ${BOOST_DEBUG_LIBRARIES} ${BOOST_FILESYSTEM_LIBRARY_DEBUG} )
...
#-- Find a Release Library -------------------------------------------
 ...
 IF (BOOST_FILESYSTEM_LIBRARY_RELEASE)
  SET(BOOST_RELEASE_LIBRARIES ${BOOST_DEBUG_LIBRARIES} ${BOOST_FILESYSTEM_LIBRARY_RELEASE} )
...
#-- Find a Debug Library ---------------------------------------------
 ...
 IF (BOOST_IOSTREAMS_LIBRARY_DEBUG)
  SET(BOOST_DEBUG_LIBRARIES ${BOOST_DEBUG_LIBRARIES} ${BOOST_IOSTREAMS_LIBRARY_DEBUG} )
...
#-- Find a Release Library -------------------------------------------
 ...
 IF (BOOST_IOSTREAMS_LIBRARY_RELEASE)
  SET(BOOST_RELEASE_LIBRARIES ${BOOST_DEBUG_LIBRARIES} ${BOOST_IOSTREAMS_LIBRARY_RELEASE} )
...
#-- Find a Debug Library ---------------------------------------------
 ...
 IF (BOOST_PRO_EXEC_MONITOR_LIBRARY_DEBUG)
  SET(BOOST_DEBUG_LIBRARIES ${BOOST_DEBUG_LIBRARIES} ${BOOST_PRO_EXEC_MONITOR_LIBRARY_DEBUG} )
...
#-- Find a Release Library -------------------------------------------
 ...
 IF (BOOST_PRO_EXEC_MONITOR_LIBRARY_RELEASE)
  SET(BOOST_RELEASE_LIBRARIES ${BOOST_DEBUG_LIBRARIES} ${BOOST_PRO_EXEC_MONITOR_LIBRARY_RELEASE} )
...
#-- Find a Debug Library ---------------------------------------------
 ...
 IF (BOOST_PROGRAM_OPTIONS_LIBRARY_DEBUG)
  SET(BOOST_DEBUG_LIBRARIES ${BOOST_DEBUG_LIBRARIES} ${BOOST_PROGRAM_OPTIONS_LIBRARY_DEBUG} )
...
#-- Find a Release Library -------------------------------------------
 ...
 IF (BOOST_PROGRAM_OPTIONS_LIBRARY_RELEASE)
  SET(BOOST_RELEASE_LIBRARIES ${BOOST_DEBUG_LIBRARIES} ${BOOST_PROGRAM_OPTIONS_LIBRARY_RELEASE} )
...
#-- Find a Debug Library ---------------------------------------------
 ...
 IF (BOOST_PYTHON_LIBRARY_DEBUG)
  SET(BOOST_DEBUG_LIBRARIES ${BOOST_DEBUG_LIBRARIES} ${BOOST_PYTHON_LIBRARY_DEBUG} )
...
#-- Find a Release Library -------------------------------------------
 ...
 IF (BOOST_PYTHON_LIBRARY_RELEASE)
  SET(BOOST_RELEASE_LIBRARIES ${BOOST_DEBUG_LIBRARIES} ${BOOST_PYTHON_LIBRARY_RELEASE} )
...
#-- Find a Debug Library ---------------------------------------------
 ...
 IF (BOOST_REGEX_LIBRARY_DEBUG)
  SET(BOOST_DEBUG_LIBRARIES ${BOOST_DEBUG_LIBRARIES} ${BOOST_REGEX_LIBRARY_DEBUG} )
...
#-- Find a Release Library -------------------------------------------
 ...
 IF (BOOST_REGEX_LIBRARY_RELEASE)
  SET(BOOST_RELEASE_LIBRARIES ${BOOST_DEBUG_LIBRARIES} ${BOOST_REGEX_LIBRARY_RELEASE} )
...
#-- Find a Debug Library ---------------------------------------------
 ...
 IF (BOOST_SERIALIZATION_LIBRARY_DEBUG)
  SET(BOOST_DEBUG_LIBRARIES ${BOOST_DEBUG_LIBRARIES} ${BOOST_SERIALIZATION_LIBRARY_DEBUG} )
...
#-- Find a Release Library -------------------------------------------
 ...
 IF (BOOST_SERIALIZATION_LIBRARY_RELEASE)
  SET(BOOST_RELEASE_LIBRARIES ${BOOST_DEBUG_LIBRARIES} ${BOOST_SERIALIZATION_LIBRARY_RELEASE} )
...
#-- Find a Debug Library ---------------------------------------------
 ...
 IF (BOOST_SIGNALS_LIBRARY_DEBUG)
  SET(BOOST_DEBUG_LIBRARIES ${BOOST_DEBUG_LIBRARIES} ${BOOST_SIGNALS_LIBRARY_DEBUG} )
...
#-- Find a Release Library -------------------------------------------
 ...
 IF (BOOST_SIGNALS_LIBRARY_RELEASE)
  SET(BOOST_RELEASE_LIBRARIES ${BOOST_DEBUG_LIBRARIES} ${BOOST_SIGNALS_LIBRARY_RELEASE} )
...
#-- Find a Debug Library ---------------------------------------------
 ...
 IF (BOOST_TEST_EXEC_MONITOR_LIBRARY_DEBUG)
  SET(BOOST_DEBUG_LIBRARIES ${BOOST_DEBUG_LIBRARIES} ${BOOST_TEST_EXEC_MONITOR_LIBRARY_DEBUG} )
...
#-- Find a Release Library -------------------------------------------
 ...
 IF (BOOST_TEST_EXEC_MONITOR_LIBRARY_RELEASE)
  SET(BOOST_RELEASE_LIBRARIES ${BOOST_DEBUG_LIBRARIES} ${BOOST_TEST_EXEC_MONITOR_LIBRARY_RELEASE} )
...
#-- Find a Debug Library ---------------------------------------------
 ...
 IF (BOOST_THREAD_LIBRARY_DEBUG)
  SET(BOOST_DEBUG_LIBRARIES ${BOOST_DEBUG_LIBRARIES} ${BOOST_THREAD_LIBRARY_DEBUG} )
...
#-- Find a Release Library -------------------------------------------
 ...
 IF (BOOST_THREAD_LIBRARY_RELEASE)
  SET(BOOST_RELEASE_LIBRARIES ${BOOST_DEBUG_LIBRARIES} ${BOOST_THREAD_LIBRARY_RELEASE} )
...
#-- Find a Debug Library ---------------------------------------------
 ...
 IF (BOOST_UNIT_TEST_FRAMEWORK_LIBRARY_DEBUG)
  SET(BOOST_DEBUG_LIBRARIES ${BOOST_DEBUG_LIBRARIES} ${BOOST_UNIT_TEST_FRAMEWORK_LIBRARY_DEBUG} )
