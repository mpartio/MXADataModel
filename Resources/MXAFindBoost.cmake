...
FIND_LIBRARY(BOOST_DATE_TIME_DEBUG_LIBRARY
  NAMES ${BOOST_LIB_PREFIX}${BOOST_DEBUG_LIB_NAME}
  PATHS ${BOOST_LIBRARIES_SEARCH_DIRS}
  NO_DEFAULT_PATH
  )
IF (BOOST_DATE_TIME_DEBUG_LIBRARY)
  SET(BOOST_DEBUG_LIBRARIES
    ${BOOST_DEBUG_LIBRARIES}
    ${BOOST_DATE_TIME_DEBUG_LIBRARY}
  )
  MARK_AS_ADVANCED(BOOST_DATE_TIME_DEBUG_LIBRARY)
  #MESSAGE(STATUS "Found ${BOOST_DATE_TIME_DEBUG_LIBRARY}")
ENDIF (BOOST_DATE_TIME_DEBUG_LIBRARY)

FIND_LIBRARY(BOOST_DATE_TIME_RELEASE_LIBRARY
  NAMES ${BOOST_LIB_PREFIX}${BOOST_RELEASE_LIB_NAME}
  PATHS ${BOOST_LIBRARIES_SEARCH_DIRS}
  NO_DEFAULT_PATH
  )
IF (BOOST_DATE_TIME_RELEASE_LIBRARY)
  SET(BOOST_RELEASE_LIBRARIES
    ${BOOST_RELEASE_LIBRARIES}
    ${BOOST_DATE_TIME_RELEASE_LIBRARY}
  )
  MARK_AS_ADVANCED(BOOST_DATE_TIME_RELEASE_LIBRARY)
  #MESSAGE(STATUS "Found ${BOOST_DATE_TIME_RELEASE_LIBRARY}")
ENDIF (BOOST_DATE_TIME_RELEASE_LIBRARY)
#MESSAGE(STATUS "BOOST_DATE_TIME_RELEASE_LIBRARY: ${BOOST_DATE_TIME_RELEASE_LIBRARY}")
#MESSAGE(STATUS "BOOST_DATE_TIME_DEBUG_LIBRARY: ${BOOST_DATE_TIME_DEBUG_LIBRARY}")
