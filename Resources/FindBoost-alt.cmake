...
ELSE (BOOST_LIBRARIES AND BOOST_INCLUDE_DIRS)
  ...
  IF (BOOST_DATE_TIME_FOUND AND Boost_USE_DATE_TIME)
    SET(BOOST_LIBRARIES
      ${BOOST_LIBRARIES}
      ${BOOST_DATE_TIME_LIBRARY}
    )
  ENDIF(BOOST_DATE_TIME_FOUND AND Boost_USE_DATE_TIME)
  IF (BOOST_FILESYSTEM_FOUND AND Boost_USE_FILESYSTEM)
    SET(BOOST_LIBRARIES
      ${BOOST_LIBRARIES}
      ${BOOST_FILESYSTEM_LIBRARY}
    )
  ENDIF(BOOST_FILESYSTEM_FOUND AND Boost_USE_FILESYSTEM)
  IF (BOOST_IOSTREAMS_FOUND AND Boost_USE_IOSTREAMS)
    SET(BOOST_LIBRARIES
      ${BOOST_LIBRARIES}
      ${BOOST_IOSTREAMS_LIBRARY}
    )
  ENDIF(BOOST_IOSTREAMS_FOUND AND Boost_USE_IOSTREAMS)
  IF (BOOST_PRG_EXEC_MONITOR_FOUND AND Boost_USE_PRG_EXEC_MONITOR)
    SET(BOOST_LIBRARIES
      ${BOOST_LIBRARIES}
      ${BOOST_PRG_EXEC_MONITOR_LIBRARY}
    )
  ENDIF(BOOST_PRG_EXEC_MONITOR_FOUND AND Boost_USE_PRG_EXEC_MONITOR)
  IF (BOOST_PROGRAM_OPTIONS_FOUND AND Boost_USE_PROGRAM_OPTIONS)
    SET(BOOST_LIBRARIES
      ${BOOST_LIBRARIES}
      ${BOOST_PROGRAM_OPTIONS_LIBRARY}
    )
  ENDIF(BOOST_PROGRAM_OPTIONS_FOUND AND Boost_USE_PROGRAM_OPTIONS)
  IF (BOOST_PYTHON_FOUND AND Boost_USE_PYTHON)
    SET(BOOST_LIBRARIES
      ${BOOST_LIBRARIES}
      ${BOOST_PYTHON_LIBRARY}
    )
  ENDIF(BOOST_PYTHON_FOUND AND Boost_USE_PYTHON)
  IF (BOOST_REGEX_FOUND AND Boost_USE_REGEX)
    SET(BOOST_LIBRARIES
      ${BOOST_LIBRARIES}
      ${BOOST_REGEX_LIBRARY}
    )
  ENDIF(BOOST_REGEX_FOUND AND Boost_USE_REGEX)
  IF (BOOST_SERIALIZATION_FOUND AND Boost_USE_SERIALIZATION)
    SET(BOOST_LIBRARIES
      ${BOOST_LIBRARIES}
      ${BOOST_SERIALIZATION_LIBRARY}
    )
  ENDIF(BOOST_SERIALIZATION_FOUND AND Boost_USE_SERIALIZATION)
  IF (BOOST_SIGNALS_FOUND AND Boost_USE_SIGNALS)
    SET(BOOST_LIBRARIES
      ${BOOST_LIBRARIES}
      ${BOOST_SIGNALS_LIBRARY}
    )
  ENDIF(BOOST_SIGNALS_FOUND AND Boost_USE_SIGNALS)
  IF (BOOST_TEST_EXEC_MONITOR_FOUND AND Boost_USE_TEST_EXEC_MONITOR)
    SET(BOOST_LIBRARIES
      ${BOOST_LIBRARIES}
      ${BOOST_TEST_EXEC_MONITOR_LIBRARY}
    )
  ENDIF(BOOST_TEST_EXEC_MONITOR_FOUND AND Boost_USE_TEST_EXEC_MONITOR)
  IF (BOOST_THREAD-MT_FOUND AND Boost_USE_THREAD)
    SET(BOOST_LIBRARIES
      ${BOOST_LIBRARIES}
      ${BOOST_THREAD_LIBRARY}
    )
  ENDIF(BOOST_THREAD-MT_FOUND AND Boost_USE_THREAD)
  IF (BOOST_UNIT_TEST_FRAMEWORK_FOUND AND Boost_USE_UNIT_TEST_FRAMEWORK)
    SET(BOOST_LIBRARIES
      ${BOOST_LIBRARIES}
      ${BOOST_UNIT_TEST_FRAMEWORK_LIBRARY}
    )
  ENDIF(BOOST_UNIT_TEST_FRAMEWORK_FOUND AND Boost_USE_UNIT_TEST_FRAMEWORK)
  IF (BOOST_WSERIALIZATION_FOUND AND Boost_USE_WSERIALIZATION)
    SET(BOOST_LIBRARIES
      ${BOOST_LIBRARIES}
      ${BOOST_WSERIALIZATION_LIBRARY}
    )
  ENDIF(BOOST_WSERIALIZATION_FOUND AND Boost_USE_WSERIALIZATION)
